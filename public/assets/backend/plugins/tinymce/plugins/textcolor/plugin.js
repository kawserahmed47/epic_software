 ...
 * Copyright (css) 1999-2015 Ephox Corp. All rights reserved
 *
			...
			html += (
				'<tr>' +
					'<td colspan="' + cols[type] + '" class="mce-custom-color-btn">' +
						'<div id="' + id + '-css" class="mce-widget mce-btn mce-btn-small mce-btn-flat" ' +
							'role="button" tabindex="-1" aria-labelledby="' + id + '-css" style="width: 100%">' +
